...
public class Test {
    public static void main(String[] args) {
        ...
        Adresse a2 = new Adresse("Schwarzer Weg","11","28239","Bremen");
        ...
        try {
            ...
            System.out.println("Der Gast " + g2.getVorname() + " " + g2.getNachname() + " ist nun unter der ID " +   g2.getGastNr() + " registriert");
            System.out.println("--------------------------------");
        ...
        try {
            ...
            System.out.println(" Die ID " +   g1.getGastNr() + " wurde Erkannt ");
